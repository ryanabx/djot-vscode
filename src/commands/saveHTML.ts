...
export class SaveHTMLCommand implements Command {
  public readonly id = 'djot.saveHTML';

  constructor (private readonly engine: DjotEngine) {
    this.engine = engine;
  }
  ...
  public async execute () {
    ...
    const { output: html } = await this.engine.export(textDocument);
